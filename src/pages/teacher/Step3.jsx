...
function Step3({ handleNext, handlePrev }) {
  return (
    <div>
      {/* FORM */}
      <section class="max-w-4xl p-6 mx-auto bg-white rounded-md shadow-md dark:bg-gray-800 my-6 font-cairoRegular">
        ...
        <div className="flex flex-col justify-center mt-6 items-center">
          ...
          <h2 className="font-cairoBold text-md mt-2">اسم الأستاذ الكامل</h2>
        </div>
        {/* Details */}
        <div className="mt-8">
          <div className="">
            <h3 className="font-cairoSemiBold">البريد الالكتروني</h3>
            <p className="text-[#333333]">name.teacher@school.com</p>
          </div>
          <div className="my-2">
          ...
          <div className="">
            ...
            <p className="text-[#333333]">1988-10-23</p>
          </div>
          <div className="my-2">
          ...
          <div>
            ...
            <p className="text-[#333333]">علوم كيمياء</p>
          </div>
          <div className="my-2">
          ...
          <div>
            ...
            <p className="text-[#333333]">5 سنوات</p>
          </div>
        </div>
      </section>
      {/* BUTTONS */}
